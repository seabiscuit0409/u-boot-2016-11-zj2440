...
#define MTDIDS_DEFAULT	"nand0=zj2440"					/*表示哪一个设备*/
#define MTDPARTS_DEFAULT "mtdparts=zj2440:1m(u-boot),"\
																		"128k(params),"\
																		"4m(kernel),"\
																		"-(rootfs)"
...
/*addr of environment in nor flash*/
/*fixed by seabiscuit*/
/*#define CONFIG_ENV_ADDR			(CONFIG_SYS_FLASH_BASE + 0x070000)*/
/*#define CONFIG_ENV_ADDR (CONFIG_SYS_FLASH_BASE + 0x1F0000)*/

/*define environment from nor to nand*/
